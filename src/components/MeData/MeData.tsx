...
interface MeDataProps {
	style?: React.CSSProperties;
}

const MeData: FC<MeDataProps> = ({ style }) => {
	return (
		<div
			className="block me"
			style={style}>
			<div className="me-info">
				<div className="me-info-text">
					...
					<div>
						<h1>
							Hola, Soy <strong>David Huang Xie</strong>, un Desarrollador Web que le apasionan las
							nuevas tecnologías y el desarrollo de páginas web.
						</h1>
						<p>
							Me especializo en <strong>desarrollo web</strong>, tanto a <strong>código</strong>{" "}
							como con <strong>WordPress</strong> y <strong>SEO OnPage</strong>.
						</p>
					</div>
				</div>
